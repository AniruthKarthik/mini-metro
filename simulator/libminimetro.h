...
/* package github.com/AniruthKarthik/mini-metro/simulator/c_api */
...
extern void GetObservation(uintptr_t handle, float* outNodes, int32_t* outEdges, float* outGlobals);
